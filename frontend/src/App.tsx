...
import { OfflineLibrary } from './components/Playlists/OfflineLibrary';
    ...
    <div className="h-full w-full relative text-white flex flex-col overflow-hidden select-none transition-colors duration-500">
      ...
      {theme === 'glass' && (
        <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden" aria-hidden="true">
          <div className="absolute -top-32 -left-32 w-[32rem] h-[32rem] bg-indigo-500/10 rounded-full blur-[120px]" />
          <div className="absolute top-1/2 -right-32 w-[32rem] h-[32rem] bg-sky-500/10 rounded-full blur-[120px]" />
          <div className="absolute -bottom-32 left-1/4 w-[32rem] h-[32rem] bg-violet-500/10 rounded-full blur-[120px]" />
        </div>
      )}
      ...
      <main className="flex-1 overflow-y-auto overflow-x-hidden relative z-10 overscroll-contain">
        ...
        {activeTab === 'offline' && <OfflineLibrary />}
